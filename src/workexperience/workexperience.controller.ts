...
export class WorkexperienceController {
    ...
    @Post('add')
    uploadWorkExperience(@GetCurrentUserId() userId : string, dto : WorkExperienceDTO ){
    ...
    @Put('update/:id')
    updateWorkExperience(@GetCurrentUserId() userId : string, dto : WorkExperienceDTO, @Param('id') experienceId : string){
        this.workExperience.updateWorkExperience(userId, experienceId, dto);
    }

    @Delete('remove')
    removeWorkExperience(@GetCurrentUserId() userId : string, @Body() workExperienceId : string){
