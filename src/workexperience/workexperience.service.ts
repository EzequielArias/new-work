...
export class WorkexperienceService {
    ...
    async uploadWorkExperince(userId : string, dto : WorkExperienceDTO) : Promise<void | Error>{
        try {
    ...
    async updateWorkExperience(userId : string, experienceId : string, data : WorkExperienceDTO){
        try {
