...
import { FirebaseStorage, getDownloadURL, getStorage, ref, uploadBytes, deleteObject } from 'firebase/storage'
...
export class FirebaseService {
    ...
    async uploadFiles(file: any, id : string, postOrUser : boolean) {
        ...
        try {
            const storageRef = ref(this.storage, `${postOrUser ? 'posts' : 'profile'}/${id}`);
